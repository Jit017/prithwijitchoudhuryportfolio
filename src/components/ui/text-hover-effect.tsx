  ...
  return (
    ...
    >
      ...
      <motion.text
        ...
        dominantBaseline="middle"
        strokeWidth="0.3"
        className="font-[helvetica] font-bold fill-transparent text-7xl stroke-neutral-200 dark:stroke-neutral-800/30"
        initial={{ strokeDashoffset: 1000, strokeDasharray: ".5 .5 1000" }}
        animate={{
          strokeDashoffset: 0,
